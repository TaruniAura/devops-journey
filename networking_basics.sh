That's a good plan. Understanding networking first will make Linux process management and later Docker/Kubernetes much easier.

For DevOps, you don't need to memorize networking terms. You need to understand how data travels from your computer to a server.

Let's learn it like a story.
